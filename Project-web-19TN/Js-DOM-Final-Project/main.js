...
if(typeof(Storage) !== 'undefined'){
  if (localStorage.length === 0 || localStorage.getItem("items") === undefined){
    Array.from(items).forEach(function(item){
      var itemName = item.firstChild.textContent;
      itemsStorage.push(itemName);
    });
    ...
    removeAllItems();
    Array.from(itemsStorage).forEach(function(item){
